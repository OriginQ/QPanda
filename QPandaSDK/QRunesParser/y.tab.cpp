...
#define DOUBLE 259
#define TRIPLE 260
#define SINGLEANGLE 261
#define DOUBLEANGLE 262
#define MEASURE 263
#define CONTROL 264
#define ENDCONTROL 265
#define PMEASURE 266
#define INT 267
#define FLOAT 268
#define ENDLINE 269
...
{
       0,    35,    35,    50,    54,    64,    77,    94,   107,   119,
     121,   126,   146,   159,   172,   178,   184,   197,   210,   223,
     236,   252,   256,   257,   258,   262,   263,   264,   276,   277,
     289,   290,   291,   292,   293
};
#endif
...
{
  "$end", "error", "$undefined", "SINGLE", "DOUBLE", "TRIPLE",
  "SINGLEANGLE", "DOUBLEANGLE", "MEASURE", "CONTROL", "ENDCONTROL",
  "PMEASURE", "INT", "FLOAT", "ENDLINE", "DAGGER", "QINIT", "CREG",
  "ENDDAGGER", "'+'", "'-'", "'*'", "'/'", "'^'", "'$'", "'('", "')'",
  "'\"'", "','", "$accept", "file", "pmeasure", "pmeasure_list", "qinit",
  "cinit", "gatelist", "gateline", "angle", "additive", "multiplicative",
  "exp", "primary", YY_NULLPTR
};
#endif
...
{
      -3,     7,    37,    25,   -49,   -49,    31,    18,   -49,    33,
      34,    35,    36,    38,    39,    40,    41,   -49,   -49,    -1,
     -49,   -49,    21,    26,    27,    28,    29,   -49,   -49,    46,
     -49,   -49,    47,    48,    42,    49,    43,   -49,    44,   -49,
      45,    19,    50,    51,    52,    53,   -49,   -49,    19,    19,
      19,    54,    -4,     8,    56,   -49,    55,   -49,   -49,   -49,
     -49,   -49,    -8,   -49,    19,    19,    19,    19,    19,    19,
     -49,     8,     8,    56,    56,   -49,    57,   -49
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       9,    16,     0,     0,     0,     0,     0,    12,    13,     0,
       3,    10,     0,     0,     0,     0,     0,     6,     4,    17,
       0,     0,     0,     0,     0,     0,    33,    34,     0,     0,
       0,     0,    21,    22,    25,    28,     0,    11,     5,    18,
      32,    31,     0,    19,     0,     0,     0,     0,     0,     0,
      30,    23,    24,    26,    27,    29,     0,    20
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -49,   -49,   -49,   -49,   -49,   -49,   -49,    58,    -7,    16,
     -30,   -26,   -48
};
...
static const yytype_uint8 yytable[] =
{
      ...
      29,    64,    65,     1,    17,    64,    65,    18,    70,     4,
      75,     9,    10,    11,    12,    13,    14,    15,    16,    66,
      67,    46,    47,    17,    71,    72,    18,     5,    48,    49,
      73,    74,     6,     8,    50,    21,    22,    23,    24,    32,
      25,    26,    27,    28,    33,    34,    35,    36,    37,    39,
      40,    42,    76,    57,    58,    59,    62,    43,     0,    41,
       0,     0,    44,    45,     0,     0,     0,    31,    56,    68,
       0,    63,    69,     0,    77
};
...
static const yytype_int8 yycheck[] =
{
      ...
      11,    19,    20,    16,    15,    19,    20,    18,    26,    12,
      68,     3,     4,     5,     6,     7,     8,     9,    10,    21,
      22,    12,    13,    15,    64,    65,    18,     0,    19,    20,
      66,    67,    17,    12,    25,    12,    12,    12,    12,    28,
      12,    12,    12,    12,    28,    28,    28,    28,    12,    12,
      12,    12,    69,    12,    12,    12,    50,    24,    -1,    27,
      -1,    -1,    28,    28,    -1,    -1,    -1,    19,    28,    23,
      -1,    27,    27,    -1,    27
};
...
{
       0,    16,    30,    33,    12,     0,    17,    34,    12,     3,
       4,     5,     6,     7,     8,     9,    10,    15,    18,    35,
      36,    12,    12,    12,    12,    12,    12,    12,    12,    11,
      31,    36,    28,    28,    28,    28,    28,    12,    32,    12,
      12,    27,    12,    24,    28,    28,    12,    13,    19,    20,
      25,    37,    38,    39,    40,    41,    28,    12,    12,    12,
      41,    41,    38,    27,    19,    20,    21,    22,    23,    27,
      26,    39,    39,    40,    40,    41,    37,    27
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,    29,    30,    30,    31,    32,    32,    33,    34,    35,
...
#line 95 "yacc.y" /* yacc.c:1646  */
    {
    extern int qNum;    
    qNum=(yyvsp[0].iInteger);
    //using std::endl;
    //using std::stringstream;
    //extern stringstream outStrStream;
    //outStrStream<<qNum<<endl;    
}
...
#line 108 "yacc.y" /* yacc.c:1646  */
    {
    extern int cNum;
    cNum=(yyvsp[0].iInteger);
    //using std::endl;
    //using std::stringstream;
    //extern stringstream outStrStream;
    //outStrStream<<cNum<<endl;    
}
...
#line 147 "yacc.y" /* yacc.c:1646  */
    ...
    {    
        ...
        _G_qList.ControlInsert((yyvsp[0].iInteger));
    }
    else
    {
        yyerror(QUBIT_OUT_OF_BOUNDS_ERROR);
...
#line 160 "yacc.y" /* yacc.c:1646  */
    ...
    if ((yyvsp[0].iInteger)<qNum)
    {    
        _G_qList.ControlDelete((yyvsp[0].iInteger));
    }
    else
    {
        yyerror(QUBIT_OUT_OF_BOUNDS_ERROR);
